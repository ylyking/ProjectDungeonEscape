...
ADungeonEscapeCharacter::ADungeonEscapeCharacter()
{
	...
	moveUpDown.Set(1, 0, 0);
	moveLeftRight.Set(0, 1, 0);
}

void ADungeonEscapeCharacter::Tick(float DeltaSeconds)
{
...
void ADungeonEscapeCharacter::MoveUpDown(float value) {
	...
	if (value != 0) {
		AddMovementInput(moveUpDown, value);
	}
}

void ADungeonEscapeCharacter::MoveLeftRight(float value) {
